...
<head>
    ...
    <title>Advocate Dashboard | Token Management System</title>
    ...
    <div class="wrapper">
        <header class="app-topbar bg-white shadow-sm pt-2">
            <div class="page-container topbar-menu px-3 d-flex justify-content-between align-items-center">
                ...
                <!-- Logo -->
                <a href="{{ route('advocate.dashboard') }}" class="d-flex align-items-center">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end shadow">
                            ...
                            <a href="{{ url('advocate/profile')}}" class="dropdown-item">
                                <i class="ti ti-user me-2"></i> Profile
                            </a>
                            <a href="{{ route('advocate.reports.completed') }}" class="dropdown-item">
